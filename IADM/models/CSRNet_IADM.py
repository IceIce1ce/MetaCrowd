...
class CSRNet_IADM(nn.Module):
    def __init__(self, ratio=0.7):
        super(CSRNet_IADM, self).__init__()
        c1 = int(64 * ratio)
        c2 = int(128 * ratio)
        c3 = int(256 * ratio)
        c4 = int(512 * ratio)
        ...
        self.block4 = Block([c4, c4, c4], in_channels=c3)
        self.backend_feat = [c4, c4, c4, c3, c2, 64]
        self.backend = make_layers(self.backend_feat, in_channels=c4, d_rate=2)
        self.reg_layer = nn.Conv2d(64, 1, kernel_size=1)
